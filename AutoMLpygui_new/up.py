...
class up(object):
    ...
    def selectFile(self):
        ...
        os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r'D:\SchoolWorks\ATSL-5124\AutoMLpygui\automl-bigdata-7c2859c8477a.json'
        bucket_name = 'automl-bigdataarch'
        blob_name = selected_file_path.split('/')[-1]
        storage_client = storage.Client()
        bucket = storage_client.bucket(bucket_name)
        blob = bucket.blob(f'raw_datafiles/{blob_name}')
